package com.mygdx.chickengame.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new ChickenGame(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("ChickenGame");
        ...
        // Cấu hình kích thước màn hình phù hợp với game (800x600)
        configuration.setWindowedMode(1000, 750); // Tăng lên để có UI thoải mái hơn
